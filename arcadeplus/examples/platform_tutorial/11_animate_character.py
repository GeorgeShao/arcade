...
python -m arcadeplus.examples.platform_tutorial.11_animate_character
"""
import arcadeplus
import os
...
class MyGame(arcadeplus.Window):
    ...
    def on_draw(self):
        ...
        #     wall.draw_hit_box(arcadeplus.color.BLACK, 3)
        #
        # self.player_sprite.draw_hit_box(arcadeplus.color.RED, 3)
