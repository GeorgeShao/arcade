...
def test_isometric_grid_to_screen():
    ...
    tile_width = 64
    tile_height = 64
    x, y = arcadeplus.isometric_grid_to_screen(tile_x, tile_y,
                                           width, height,
...
def test_screen_to_isometric_grid():
    ...
    tile_width = 64
    tile_height = 64
    x, y = arcadeplus.screen_to_isometric_grid(screen_x, screen_y,
                                           width, height,
                                           tile_width, tile_height)
    print(x, y)
    assert x == 4
...
def test_create_isometric_grid_lines():
    ...
    lines = arcadeplus.create_isometric_grid_lines(width, height,
                                               tile_width, tile_height,
