...
from arcadeplus.utils import _Vec2  # importing internal implementation class


def test_lerp():
    assert arcadeplus.lerp(2.0, 4.0, 0.75) == approx(3.5)


def test_lerp_vec():
    vec = arcadeplus.lerp_vec((0.0, 2.0), (8.0, 4.0), 0.25)
...
def test_rand_in_rect():
    """Smoke test"""
    arcadeplus.rand_in_rect((10.0, 20.0), 30.5, 5.1)


def test_rand_in_circle():
    """Smoke test"""
    arcadeplus.rand_in_circle((0, 0), 10.0)
...
def test_rand_angle_360_deg():
    """Smoke test"""
    arcadeplus.rand_angle_360_deg()


def test_rand_angle_spread_deg():
    """Smoke test"""
    arcadeplus.rand_angle_spread_deg(45.0, 5.0)


def test_rand_vec_spread_deg():
    """Smoke test"""
    arcadeplus.rand_vec_spread_deg(-45.0, 5.0, 3.3)


def test_rand_vec_magnitude():
    """Smoke test"""
    arcadeplus.rand_vec_magnitude(30.5, 3.3, 4.4)
